...
from util import chat_completion, annotate_tag, eval_preference_win_loss_ratio, Keys, random_select_prompt
...
for i in range(total_iterations):
    ...
    try:
        ...
        print(f"AssertionError: question_A = {question_A}, question_B = {question_B}")
