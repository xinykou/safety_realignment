...
accelerate launch --config_file ../scripts/performance/peft_config.yaml src/train_bash.py \
    ...
    --output_dir ../saved_models/$save_name \
    --overwrite_cache \
...
#    --model_name_or_path /home/yx/model_cache/llama-2-7b-chat \
#    --adapter_name_or_path ../saved_models/$save_name/checkpoint-1500 \
#    --template llama2 \
#    --finetuning_type lora \
#    --export_dir ../saved_models/$save_name-merged-best \
#    --export_size 10 \
...
#    --model hf \
#    --model_args pretrained=saved_models/$save_name-merged-best \
#    --tasks xcopa \
#    --batch_size 8