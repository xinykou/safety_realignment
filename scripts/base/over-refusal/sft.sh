...
task_name_list=("Safe-WizardLM-7b-sft-alpaca_en/checkpoint-1500"
                "Safe-WizardLM-7b-sft-alpaca_zh/checkpoint-1500"
                "Safe-WizardLM-7b-sft-hindi/checkpoint-2400"
                "Safe-WizardLM-7b-sft-math/checkpoint-300"
                "Safe-WizardLM-7b-sft-code/checkpoint-900")
...
for i in ${!task_name_list[@]}; do
  ...
  trained_model_path=../saved_models/sft/$task_name
  pretained_model_path=/home/yx/model_cache/WizardLM-7B-Uncensored
  output_dir=../safety_results/Over-refusal_WizardLM-sft/$map_task_name
