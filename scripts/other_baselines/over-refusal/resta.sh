...
task_name_list=("copa" "xcopa_zh" "xnli_hi" "gsm8k" "HumanEval") # ("copa" "xcopa_zh" "xnli_hi" "gsm8k" "HumanEval")
...
for i in ${!task_name_list[@]}; do
  ...
  output_dir=../safety_results/Over-refusal_WizardLM_other_baselines/$safety_methods-$map_task_name
