...
model_type=WizardLM-multi_realign_binary_dpo
pretained_model_path=/home/yx/model_cache/WizardLM-7B-Uncensored
multi_dpo_model_name=Safe-WizardLM-7b-multi_realign_mask_dpo-task_arithmetic/checkpoint-300
output_dir=../safety_results/$model_type/$dataset_name--task_arithmetic
...
python src/train_bash.py \
    ...
    --adapter_name_or_path ../saved_models/multi_realign/$multi_dpo_model_name\
