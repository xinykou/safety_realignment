...
multi_dpo_model_name=Safe-WizardLM-7b-multi_realign_mask_dpo-ties_merging/checkpoint-200
output_dir=../safety_results/$model_type/$dataset_name--ties_merging
