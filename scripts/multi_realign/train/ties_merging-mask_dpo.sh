...
model_type=mask_dpo
save_name=Safe-WizardLM-7b-multi_realign_$model_type-ties_merging
...
python src/train_bash.py \
    ...
    ../saved_models/sft/Safe-WizardLM-7b-sft-alpaca_zh/checkpoint-1500 \
    ...
    --task_vectors_merged_methods ties_merging \
    --dataset pku_seferlhf_realign_dpo_5k \
    --template WizardLM-7B \
    --finetuning_type mask \
    --lora_target q_proj,v_proj \
    --output_dir ../saved_models/multi_realign/$save_name \
    --overwrite_cache \
