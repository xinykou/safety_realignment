...
dpo_adaptor_path=../saved_models/multi_realign/Safe-WizardLM-7b-multi_realign_mask_dpo-weight_averaging-nums_4
safety_adaptor_path=../saved_models/pretrain/Safe-WizardLM-7b-pretrain_sft_after_dpo/checkpoint-4371
checkpoint=checkpoint-321
task_name_list=("xcopa_zh" "xnli_hi" "gsm8k")   # "copa" "xcopa_zh" "xnli_hi" "gsm8k"
