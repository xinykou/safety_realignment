...
model_type=Attack_prompt-WizardLM-sft
pretained_model_path=/home/yx/model_cache/WizardLM-7B-Uncensored
sft_model_name=../saved_models/sft/Safe-WizardLM-7b-sft-alpaca_en/checkpoint-1500
...
python src/train_bash.py \
    ...
    --adapter_name_or_path $sft_model_name \
...
python evaluation/safety/gpt4_judge_preference_copy.py \
  --sft_response_file ../safety_results/WizardLM-org/$dataset_name_with_attack/generated_predictions.json \
