...
task_path_list["Chinese"]="resta-xcopa_zh"
task_path_list["Hindi"]="resta-xnli_hi"
task_path_list["English"]="resta-copa"
task_path_list["Code"]="resta-HumanEval"
task_path_list["Math"]="resta-gsm8k"

for task_name in "${!task_path_list[@]}"; do
    echo "current task: $task_name"

model_type=Helpfulness_WizardLM-resta
