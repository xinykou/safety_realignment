...
target_names=("alpaca_zh/checkpoint-500" "alpaca_en/checkpoint-500" "hindi/checkpoint-800" "code/checkpoint-900")
# shellcheck disable=SC2068
for target_name in ${target_names[@]}; do
    realign_model_name=Safe-WizardLM-7b-realign_mask_dpo-$target_name
    output_dir=../safety_results/transfer_learning/source_math--target_${target_name}
    ...
    python src/train_bash.py \
        ...
        --mask_module_path  ../saved_models/realign/Safe-WizardLM-7b-realign_mask_dpo-math/checkpoint-900 \
