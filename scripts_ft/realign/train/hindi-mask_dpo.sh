...
model_type=mask_dpo
save_name=Safe-TinyLlama-1.1b-realign_$model_type-hindi
base_name_or_path=/media/4/yx/saved_models/pretrain/Safe-TinyLlama-1.1b-pretrain_sft_after_dpo/checkpoint-8745
downtask_name_or_path=/media/4/yx/saved_models/sft/Safe-TinyLlama-1.1b-sft-hindi/checkpoint-6000
