...
model_type=mask_dpo
save_name=Safe-TinyLlama-1.1b-realign_$model_type-math
base_name_or_path=/media/4/yx/saved_models/pretrain/Safe-TinyLlama-1.1b-pretrain_sft_after_dpo/checkpoint-8745
downtask_name_or_path=/media/4/yx/saved_models/sft/Safe-TinyLlama-1.1b-sft-math/checkpoint-800
...
deepspeed --include localhost:6,7 --master_port=18328 src/train_bash.py \
    ...
    --run_name $save_name \
    --deepspeed ../scripts_ft/pretrain/dpo_deepspeed_config_scale.json
