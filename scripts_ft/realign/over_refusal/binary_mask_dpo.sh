...
realign_mask_dpo_names=("Safe-TinyLlama-1.1b-realign_mask_dpo-alpaca_zh/checkpoint-160/binary_mask_merged"
                         "Safe-TinyLlama-1.1b-realign_mask_dpo-hindi/checkpoint-160/binary_mask_merged"
                         "Safe-TinyLlama-1.1b-realign_mask_dpo-math/checkpoint-160/binary_mask_merged"
                         "Safe-TinyLlama-1.1b-realign_mask_dpo-code/checkpoint-160/binary_mask_merged") # Safe-TinyLlama-1.1b-realign_mask_dpo-alpaca_en/checkpoint-321/binary_mask_merged
