...
realign_model_name=../saved_models/realign/Safe-TinyLlama-1.1b-realign_mask_dpo-code/checkpoint-80/binary_mask_merged


# 字符串列表
dataset_name_list=("BeaverTails") # ("BeaverTails" "catqa_english" "harmfulqa" "shadow-alignment" "dangerousqa")

# 使用for循环遍历字符串列表
for dataset_name in "${dataset_name_list[@]}"; do
    echo "current datasets: $dataset_name"

output_dir=../safety_results/$model_type/$dataset_name--code
