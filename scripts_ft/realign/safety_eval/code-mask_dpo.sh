...
realign_model_name=../saved_models/realign/Safe-TinyLlama-1.1b-realign_mask_dpo-code/checkpoint-160


# 字符串列表
dataset_name_list=("catqa_english") # ("BeaverTails" "catqa_english" "harmfulqa" "shadow-alignment" "dangerousqa")
